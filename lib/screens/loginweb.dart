                    ...
                    child: AnimatedTextKit(
                      animatedTexts: [
                        TypewriterAnimatedText(
                            'La inteligencia artificial impulsa tu negocio hacia el futuro',
                            speed: Duration(milliseconds: 2)),
                        TypewriterAnimatedText(
                            'El 75% de los líderes empresariales creen que la IA es esencial para su estrategia de futuro',
                        ...
                        TypewriterAnimatedText(
                            ...
                            speed: Duration(seconds: 2)),
                        TypewriterAnimatedText(
                            'La automatización de tareas rutinarias incrementa la creatividad del equipo en un 20%',
                            speed: Duration(seconds: 2)),
                        TypewriterAnimatedText(
